...
namespace Second_Try
{
    public partial class mainForm3 : Form
    {
        ...
        {
            BacSi bs = TaiKhoanDAL.Instance.GetBacSiByID(IdTaiKhoan.idBacSiTaiKhoan);
            siticoneButton5.Text = bs.TenDangNhap;
        ...
        {
            OpenChildForm(new frmDanhSachLichDat());
        }
