...
using Second_Try.GUI;
using Second_Try.GUI.Admin;
...
namespace Second_Try
{
    public partial class mainForm2 : Form
    {
        ...
        {
            lblHaa.Text = "JT APP";
            OpenChildForm(new frmDanhSachBacSy());
        }
        ...
        {
            OpenChildForm(new frmDanhSachBenhNhan());
        }
        ...
        private void lblHaa_Click(object sender, EventArgs e)
        {
        }
